...
static func can_be_eaten(sheep, ingredient):
	...
	if ingredient == "Erdnüsse":
		if fc==e_fc.blue:
			print("Das Schaffell war " + str(e_fc.keys()[fc]) + ", es isst also keine " + str(ingredient) + "!!!")
			return false
	elif ingredient == "Gluten":
		if fc==e_fc.blue and (pt==e_pt.stripes or pt==e_pt.dots) and (not hc==e_hc.pink):
			print("Das Schaffell war " + str(e_fc.keys()[fc]) + " und das Muster war " + str(e_pt.keys()[pt]) + ", es isst also kein " + str(ingredient) + "!!!")
			return false
		...
		if hc==e_hc.black and fc==e_fc.orange:
			print("Das Schaffell war " + str(e_fc.keys()[fc]) + " und der Kopf war " + str(e_hc.keys()[hc]) + ", es isst also kein " + str(ingredient) + "!!!")
			return false
	elif ingredient == "Milch":
		if fc==e_fc.green and (pt==e_pt.checkers or pt==e_pt.none):
			print("Das Schaffell war " + str(e_fc.keys()[fc]) + " und das Muster war " + str(e_pt.keys()[pt]) + ", es isst also keine " + str(ingredient) + "!!!")
			return false
		...
		if (not hc==e_hc.pink):
			print("Die Kopffarbe war " + str(e_hc.keys()[hc]) + ", es isst also keinen " + str(ingredient) + "!!!")
			return false
	elif ingredient == "Curry":
		if pt==e_pt.dots and (not hc==e_hc.black):
			print("Das Muster war " + str(e_hc.keys()[hc]) + " und das Muster war " + str(e_pt.keys()[pt]) + ", es isst also kein " + str(ingredient) + "!!!")
			return false
	elif ingredient == "Ei":
		if (fc==e_fc.orange and hc==e_hc.black) or (pt==e_pt.stripes and hc==e_hc.white):
			print("Das Fell, Kopf, Muster: " + str(e_fc.keys()[fc]) + ", " + str(e_hc.keys()[hc]) + ", " + str(e_pt.keys()[pt]) + ", es isst also kein " + str(ingredient) + "!!!")
			return false
	elif ingredient == "Alkohol":
		if (not fc==e_fc.green) and (pt==e_pt.dots or pt==e_pt.stripes):
			print("Das Schaffell war " + str(e_fc.keys()[fc]) + " und das Muster war " + str(e_pt.keys()[pt]) + ", es isst also keinen " + str(ingredient) + "!!!")
			return false
	elif ingredient == "Knoblauch":
		if hc==e_hc.pink and pt==e_pt.none:
			print("Die Kopffarbe war " + str(e_hc.keys()[hc]) + " und das Muster war " + str(e_pt.keys()[pt]) + ", es isst also kein " + str(ingredient) + "!!!")
			return false
	elif ingredient == "Pilze":
		if fc==e_fc.blue and hc==e_hc.white:
			print("Das Schaffell war " + str(e_fc.keys()[fc]) + " und der Kopf war " + str(e_hc.keys()[hc]) + ", es isst also keine " + str(ingredient) + "!!!")
			return false
	elif ingredient == "Senf":
		if pt==e_pt.stripes:
			print("Das Muster war " + str(e_pt.keys()[pt]) + ", es isst also keinen " + str(ingredient) + "!!!")
			return false
